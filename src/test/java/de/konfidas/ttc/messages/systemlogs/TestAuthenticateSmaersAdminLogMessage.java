...
public class TestAuthenticateSmaersAdminLogMessage {
  final static Logger logger = LoggerFactory.getLogger(Logger.ROOT_LOGGER_NAME);
  final static File systemLogFiles = new File("testdata/systemlogs/authenticateSmaersAdmin/");
  ...
  public void parse(File syslog) throws Exception {
    ...
    final AuthenticateSmaersAdminSystemLogMessage message = new AuthenticateSmaersAdminSystemLogMessage(content, syslog.getName());
