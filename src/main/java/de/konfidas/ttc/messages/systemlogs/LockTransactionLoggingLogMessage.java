...
/**
 * Diese Klasse repräsentiert eine lockTransactionLogging Message. Dabei werden in der Methode
 ...
 * </pre>
 */
public class LockTransactionLoggingLogMessage extends SystemLogMessage {
    ...
    public LockTransactionLoggingLogMessage(byte[] content, String filename) throws BadFormatForLogMessageException {
